...
class ViewDetailedStatement extends React.Component {
  state = {
    statements: [],
    columns: [
      "Transaction ID",
  ...
  retrieveStatements = async () => {
    ...
    console.log(
      "Statements retrieved in retrieveTransactions() JS function " +
  ...
  render() {
    ...
    return (
      <div className="container">
        <h3>
          {auth.getCurrentCustomerName()}'s Detailed Transaction Statements 
        </h3><hr/>
...
export default ViewDetailedStatement;
